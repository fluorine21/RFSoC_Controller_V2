...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_IS_DUAL {1} \
   CONFIG.GPIO2_BOARD_INTERFACE {app_leds} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m5_axis] [get_bd_intf_pins rfsoc_pl_ctrl_verilo_0/m5_axis] [get_bd_intf_pins system_ila_pl/SLOT_9_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m5_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m6_axis] [get_bd_intf_pins rfsoc_pl_ctrl_verilo_0/m6_axis] [get_bd_intf_pins system_ila_pl/SLOT_10_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m6_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m7_axis] [get_bd_intf_pins rfsoc_pl_ctrl_verilo_0/m7_axis] [get_bd_intf_pins system_ila_pl/SLOT_11_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m7_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m8_axis] [get_bd_intf_pins rfsoc_pl_ctrl_verilo_0/m8_axis] [get_bd_intf_pins system_ila_pl/SLOT_12_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets rfsoc_pl_ctrl_verilo_0_m8_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets usp_rf_data_converter_0_m00_axis] [get_bd_intf_pins system_ila_pl/SLOT_13_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_ps_to_pl_fifo/s_axis_aresetn] [get_bd_pins axis_gpio_async_fifo/s_axis_aresetn] [get_bd_pins axis_tlast_slice_0/rst] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins rst_ps8_0_100M1/ext_reset_in] [get_bd_pins system_ila_ps/resetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
